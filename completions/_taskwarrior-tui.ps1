...
Register-ArgumentCompleter -Native -CommandName 'taskwarrior-tui' -ScriptBlock {
    ...
    $completions = @(switch ($command) {
        'taskwarrior-tui' {
            ...
            [CompletionResult]::new('-f', 'f', [CompletionResultType]::ParameterName, 'Sets default filter')
            [CompletionResult]::new('--filter', 'filter', [CompletionResultType]::ParameterName, 'Sets default filter')
